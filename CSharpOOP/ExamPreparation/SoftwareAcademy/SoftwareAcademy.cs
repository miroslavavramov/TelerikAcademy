    ...
    public abstract class Course : ICourse
    {
        ...
        public string Name
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentNullException("Course's name can't be null ot whitespace!");
                }
                this.name = value;
            }
        }
    ...
    public class LocalCourse : Course, ILocalCourse
    {
        ...
        public string Lab
        {
            ...
            set
            {
                if (string.IsNullOrWhiteSpace(value))
                {
                    throw new ArgumentNullException("Town's name can't be null ot whitespace!");
                }
                this.lab = value;
            }
        }
    ...
    public class Teacher : ITeacher
    {
        ...
        public string Name
        {
            ...
            set
            {
                if (string.IsNullOrWhiteSpace(value))
                {
                    throw new ArgumentNullException("Teacher's name can't be null ot whitespace!");
                }
                this.name = value;
            }
        }
